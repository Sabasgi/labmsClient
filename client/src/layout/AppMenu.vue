...
// var model = authstore.user.menus
var model  = ref([])
// = [{
//         label: 'Home',
...
//         label: 'Grant Access',
//         items: [
//             { label: 'Accesses', icon: 'pi pi-fw pi-eye', to: '/accesses', badge: 'NEW' },
...
<template>
    <ul class="layout-menu">
        <template v-for="(item, i) in model" :key="item">
            ...
            <li v-if="item.separator" class="menu-separator"> {{ item.separator}}</li>
