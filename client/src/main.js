...
if (process.env.NODE_ENV === "development") {
    // set baseUrl from app : local
    axios.defaults.baseURL = "http://localhost:5174/server/";
  ...
  router.beforeEach((to,from,next)=>{
    // var str = AuthStore()
    // if (str.user.roleId){
    //   for (let index = 0; index < str.user.permissions.length; index++) {
    //       // if ( str.user.menus[index] == to.path){
    //       //   console.log("routed",str.user.permissions[index])
    //       //   next()
    //       // }
